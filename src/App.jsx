...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-[radial-gradient(circle_at_top_left,_rgba(126,184,232,0.6),_transparent_22%),linear-gradient(135deg,#91c4ea_0%,#dce9f9_55%,#c4daf3_100%)] p-8">
